  ...
  <div>
    ...
    <div class="home-banner"   :style="cover">
      <div class="banner-container">
        <!-- 描述 -->
        <h1 class="blog-title animated zoomIn" style="color: #fff;text-shadow: 2px 2px 4px rgb(0 0 0 / 15%);">
          {{ blogInfo.websiteConfig.websiteName }}
        </h1>
        <!-- 一言 -->
        <div class="blog-intro" style="color: #fff;text-shadow: 2px 2px 4px rgb(0 0 0 / 15%)">
...
export default {
  ...
  computed: {
    ...
    cover() {
      ...
      return "background:linear-gradient( rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url(" + cover + ") center center / cover no-repeat";
    } // 图片变暗 background:linear-gradient( rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)),url()
  }
};
</script>
